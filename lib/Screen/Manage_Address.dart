    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          print("address_list_res_______________$data");
          ...
          for (int i = 0; i < addressList.length; i++) {
            if (addressList[i].isDefault == "1") {
              ...
              if (!ISFLAT_DEL || addressList[i].freeAmt != null|| addressList[i].freeAmt != '0') {
      ...
      addModel.add(RadioModel(
          ...
          add:
              "${addressList[i].address!}",
                  // "${addressList[i].area!}, ${addressList[i].city!}, ${addressList[i].state!}, ${addressList[i].country!}, ${addressList[i].pincode!}",
