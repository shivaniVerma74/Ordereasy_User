...
class Search extends StatefulWidget {
  bool? isSubscription;
  Search({Key? key, this.isSubscription}) : super(key: key);
...
class _SearchState extends State<Search> with TickerProviderStateMixin {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null)
        try {
          ...
          print("params________search___ ${parameter}");
          Response response =
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null)
        try {
          ...
          print("params________search2___ ${parameter}");
  ...
  _showRest() {
    return sellerLists.isNotEmpty
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ListTile(
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => SellerProfile(
                                  sellerName: sellerLists[index]["username"],
                                  sellerImage: "$sellerImage${sellerLists[index]["logo"]}",
                                  sellerStoreName: sellerLists[index]["owner_name"],
                      ...
                      title: Text("${sellerLists[index]["username"]}"),
                      // subtitle: Text(
        ...
        : Container();
    // widget.isSubscription==true?Container():
    // Column(
    //         children: [
    //           Row(
