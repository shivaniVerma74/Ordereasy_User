...
import 'package:eshop_multivendor/Screen/BakeryDetail.dart';
import 'package:eshop_multivendor/Screen/Dashboard.dart';
import 'package:eshop_multivendor/Screen/Sale.dart';
...
class _HomePageState extends State<HomePage>
                  ...
                  child: Column(
                    ...
                    //  _catList(),
                      ...
                      InkWell(
                        onTap: () {
                          print("worlingggggg");
                          MyGlobalKey.myTabPageKey.currentState!.onItemTapped(0);
                        },
                        child: Container(
                          ...
                          child: Text("${getTranslated(context, 'SUBSCRIPTION')}",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w600),),
                        ),
                      ),
                      // _section(),
                     // _seller()
                      ...
                      Padding(
                        ...
                        child: Image.asset('assets/logo/mt_logo.png',  width: MediaQuery.of(context).size.width, fit: BoxFit.contain,color: Theme.of(context).colorScheme.fontColor,),
                      ),
                      ///recent search
                      _bakeries(),
                    ],
    ...
    return GestureDetector(
      ...
      onTap: () async {
        ...
        if (homeSliderList[curSlider].type == "products") {
          print("from home to product detail");
          ...
          print("from home to product list");
          ...
          if (item.subList == null || item.subList!.length == 0) {
            ...
            print("from home to restaurant dashboard");
            // Navigator.push(
            //     context,
            //     MaterialPageRoute(
            //       builder: (context) => SubCategory(
  ...
  _bakeries() {
        return recentSearchModel == null ? Container(height: 300, child: Center(child: CircularProgressIndicator(color: colors.primary,),)) : recentSearchModel!.date == null ? SizedBox() : Padding(
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () async{
                          ...
                          // }
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> BakeryDetail(sellerData: jsonEncode(recentSearchModel!.date![index]))));
                          ///--------------
                          // } else {
