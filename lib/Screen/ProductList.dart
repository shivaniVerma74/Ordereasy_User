  ...
  removeFromCart(int index) async {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        print("params________productList___ ${parameter}");
        apiBaseHelper.postAPICall(manageCartApi, parameter).then((getdata) {
          ...
          if (!error) {
            ...
            List<SectionModel> cartList = (cart as List).map((cart) => new SectionModel.fromCart(cart)).toList();
                          ...
                          model.availability == "0" && !cartBtnList
                              ...
                              : _controller[index].text == "0"
                                  ? InkWell(
                                      onTap: () {
                                        if (_isProgress == false)
                                          addToCart(index, (int.parse(_controller[index].text.toString()) + int.parse(model.qtyStepSize!)).toString());
                                      },
                                      child: Card(
                                        elevation: 1,
                                        shape: RoundedRectangleBorder(
                                          ...
                                          GestureDetector(
                                            ...
                                            onTap: () {
                                              if (_isProgress == false)
                                                addToCart(
                                                    index,
                                                    (int.parse(_controller[index].text.toString()) +
                                                            int.parse(model
                                                                .qtyStepSize!))
                                                        .toString());
                                            },
  ...
  Future<void> addToCart(int index, String qty) async {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        print("addd to cart parameter $parameter");
