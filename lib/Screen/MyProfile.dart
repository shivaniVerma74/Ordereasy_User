...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
 ...
 // List<String> langCode = ["en", "hi", "zh", "es", "ar", "ru", "ja", "de"];
  ...
  getSharedData() async{
    ...
    nameController.text = User_name.toString();
    print("user name is ${User_name}");
    print("user od is ${User_id}");
    print("user mobile is $User_mobile");
  }
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  // Selector<UserProvider, String>(selector: (_, provider) => provider.curUserName,
                  ...
                  Text(
                    User_name == "" || User_name == null? getTranslated(context, 'GUEST')! : User_name!,
                    style: Theme.of(context)
                        .textTheme
                        .subtitle1!
                        .copyWith(
                  ...
                  User_id == "" || User_id == null ? Container():
                  Text(
                    User_mobile == "" || User_mobile == null ?  '' : User_mobile!,
...
/*  _getDivider() {
  ...
  _getDrawerItem(String title, String img) {
    return
      User_id == "" || User_id == null && title == getTranslated(context, 'LOGOUT') ? Container():
      Card(
      elevation: 0,
      child: ListTile(
        trailing: Icon(
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child:
                ...
                return
                  imgFile != null ?
                  Image.file(imgFile!,  height: 64.0,
                    width: 64.0,
                    fit: BoxFit.cover,):
  ...
  Future<void> setProfilePic(File _image) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("_image.path is ${_image.path}");
...
//                         return Text(
//                           userName == ""
//                               ? getTranslated(context, 'GUEST')!//name sahi hai
//                               : userName,
//                           style: Theme.of(context)
//                               .textTheme
//                               .subtitle1!
...
//
//                   // Text(
//                   //   User_name ?? getTranslated(context, 'GUEST')!,
//                   //   style: Theme.of(context)
//                   //       .textTheme
//                   //       .subtitle1!
//                   //       .copyWith(
