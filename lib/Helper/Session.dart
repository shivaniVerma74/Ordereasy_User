...
getAppBar(
  ...
  return AppBar(
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: InkWell(
            ...
            onTap:() {
              if(title == getTranslated(context, 'ORDER_PLACED')){
    ...
    actions: <Widget>[
      title == getTranslated(context, 'CHAT') || title == getTranslated(context, "MY_ORDERS_LBL")
      ...
      //         },
      //       ),
      title == getTranslated(context, 'CHAT')? Container():
