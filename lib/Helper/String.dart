...
final Uri updateFuid = Uri.parse(baseUrl + 'update_fuid');
final Uri noti_chat = Uri.parse(baseUrl + 'send_notification');

final Uri getSectionApi = Uri.parse(baseUrl + 'get_sections');
final Uri getSettingApi = Uri.parse(baseUrl + 'get_settings');
final Uri time_slotsApi = Uri.parse(baseUrl + 'time_slots');
...
final Uri notification_detailsApi = Uri.parse(baseUrl + 'notification_details');
...
const String USERNAME = 'fullName';
...
const String FROMTOTIME = 'to_time';
